...
public class FilterEngineInstaller {
    ...
    public void installFilterEngine(FilterEngineConfig config, String packageId) throws CommandEndedAbnormallyException {
    ...
    public void installFilteringContext(FilterEngineConfig config, String packageId) throws CommandEndedAbnormallyException {
    ...
    public void installFilterEngineBinary(String archiveUrl, String packageId) throws CommandEndedAbnormallyException {
    ...
    public void installLicenceFile(String licenceFileUrl, String packageId) throws CommandEndedAbnormallyException {
        String basePath = FilePathUtils.concatenatePath(FilePathUtils.getFolderPath(this.workspacePath, packageId), this.filterEngineFolder);
    ...
    public void installKzFile(String kzUrl, String packageId) throws CommandEndedAbnormallyException {
        String basePath = FilePathUtils.concatenatePath(FilePathUtils.getFolderPath(this.workspacePath, packageId), this.filterEngineFolder);
        Command filteringContextFileInstallCommand = new InstallFilteringContextFileCommand(basePath, kzUrl);
        filteringContextFileInstallCommand.execute();
    }

    public void installFmlFile1(String fml1Url, String packageId) throws CommandEndedAbnormallyException {
        String basePath = FilePathUtils.concatenatePath(FilePathUtils.getFolderPath(this.workspacePath, packageId), this.filterEngineFolder);
        Command filteringContextFileInstallCommand = new InstallFilteringContextFileCommand(basePath, fml1Url);
        filteringContextFileInstallCommand.execute();
    }

    public void installFmlFile2(String fml2Url, String packageId) throws CommandEndedAbnormallyException {
        String basePath = FilePathUtils.concatenatePath(FilePathUtils.getFolderPath(this.workspacePath, packageId), this.filterEngineFolder);
        Command filteringContextFileInstallCommand = new InstallFilteringContextFileCommand(basePath, fml2Url);
        filteringContextFileInstallCommand.execute();
    }

    public void installScoreFile(String scoreFileUrl, String packageId) throws CommandEndedAbnormallyException {
        String basePath = FilePathUtils.concatenatePath(FilePathUtils.getFolderPath(this.workspacePath, packageId), this.filterEngineFolder);
