...
public class CommonTasks {
    ...
    public static Integer launchShellScript(String folderPath, String moduleName, String scriptFile, String tailFolderName) throws IOException {
        Binding sharedData = new Binding();
        sharedData.setProperty("command", FileUtils.getModuleFolderPath(folderPath,moduleName) + File.separator + scriptFile );
        sharedData.setProperty("scriptFile", scriptFile);
        sharedData.setProperty("tailFolder", FileUtils.getModuleTailFolderPath(folderPath, tailFolderName, moduleName));
        GroovyShell shell = new GroovyShell(sharedData);
    ...
    public static Integer stopShellScript(String folderPath, String moduleName, String scriptFile, String tailFolderName) throws IOException {
        Binding sharedData = new Binding();
        sharedData.setProperty("scriptFile", scriptFile);
        sharedData.setProperty("tailFolder", FileUtils.getModuleTailFolderPath(folderPath, tailFolderName, moduleName));
        GroovyShell shell = new GroovyShell(sharedData);
